...
class CourseModule extends StatelessWidget {
  ...
  _buildButton(IconData icon, String text) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, size: 20, color: module.buttonColor),
          SizedBox(width: 5),
          Text(
            text,
            style: TextStyle(
...
class CourseModule1 extends StatelessWidget {
  ...
  const CourseModule1({super.key, required this.module1});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: 180,
              ...
              child: Column(
                children: [
                  Container(
                    padding: EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      border: Border.all(color: module1.iconBorder, width: 2),
  ...
  _buildButton(IconData icon, String text) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, size: 20, color: module1.buttonColor),
          SizedBox(width: 5),
          Text(
            text,
            style: TextStyle(
              color: module1.buttonFont,
              fontWeight: FontWeight.bold,
            ),
          ),
        ],
...
class CourseModule2 extends StatelessWidget {
  ...
  const CourseModule2(this.module2, {super.key});
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: 180,
              ...
              child: Column(
                children: [
                  Container(
                    padding: EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      border: Border.all(color: module2.iconBorder, width: 2),
  ...
  _buildButton(IconData icon, String text) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, size: 20, color: module2.buttonColor),
          SizedBox(width: 5),
          Text(
            text,
            style: TextStyle(
              color: module2.buttonFont,
              fontWeight: FontWeight.bold,
            ),
          ),
        ],
