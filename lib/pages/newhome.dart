...
import 'package:edumate/pages/your_classes/your_classes.dart';
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: Text("Development", style: TextStyle(fontSize: 15)),
                  ),
                ),
                SizedBox(height: 28),
                Text(
                ...
                Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 50),
                    Text("50 Results", style: TextStyle(fontSize: 13)),
                  ],
                ),
                SizedBox(height: 15),
                Container1(
