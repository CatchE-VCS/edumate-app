...
class _ContestPageState extends State<ContestPage> {
  ...
  Widget _circularContainer({required String name, required String date, required String starttime, required String endtime}) {
    return Stack(
      children: [
        Container(
        height: 73,
        ...
        Positioned(
            ...
            child: SizedBox(
                width: 122,
                child: Text("$date", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12),)
            )
        ),
        Positioned(
            top: 15,
            ...
            child: SizedBox(
                width: 122,
                child: Text("$starttime - $endtime", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),)
            )
        ),
    ]
    );
